...
public class AgronomBot extends TelegramLongPollingBot {
    ...
    private SendMediaGroup preparePhotoMessage(List<String> localPaths, ImagesOperation operation,
    ...
    public String getBotToken() {
        return "6145742368:AAFdKntMbxwcIipFghSWu3VU0NOGUZPyC1Y";
    }
